---
title: Quick Start
description: Get Utterance running in under 2 minutes. No backend, no API keys, no configuration required.
---
...
All processing happens on the main thread using WASM. Typical inference takes under 5ms per 100ms window.
